...
```bash
├── ESG_Distress_Pipeline_Colab_28042026.ipynb   # Main analysis pipeline
├── ESG_Financial_Distress_Thailand_SET.docx     # Research manuscript
├── Thailand_ESG__data_30102025.csv              # Financial + ESG dataset
├── ALL_SET_952_ESG_2013-2025_1.csv              # S&P ESG dataset
